 ...
 * @param  {...Object} objects - Об'єкти, властивості яких будуть об'єднані.
 * @returns {Object} - Новий об'єкт з об'єднаними властивостями.
 */
 ...
 * @param {Object} obj - Об'єкт, властивості якого потрібно отримати.
 * @returns {Array} - Масив, що містить усі властивості та їх значення.
 */
 ...
 * @param {Array} entries - Масив записів, кожен запис представлений як [key, value].
 * @returns {Object} - Об'єкт, створений з записів з обробленими значеннями.
 */
...
* @param {Object} obj1 - Перший вхідний об'єкт.
* @param {Object} obj2 - Другий вхідний об'єкт.
* @param {string} key - Ключ для перевірки в обох об'єктах.
 ...
 *
 * @param {Object} obj - Об'єкт, для якого потрібно обчислити суму значень.
 * @returns {number} - Сума всіх значень об'єкта.
 */
 ...
 *
 * @param {Array} arr - Масив масивів, де кожний підмасив має два елементи - ключ та значення.
 * @returns {Object} - Об'єкт, створений з масиву.
 */
function convertArrayToObj(arr) {
  ...
  // Проходимося по кожному підмасиву в масиві за допопмогою циклу for, лічильник від нуля довжини масиву
  ...
  // Використовуємо метод Object.entries() для отримання масиву ключ-значення,
  // потім застосовуємо метод Object.fromEntries() для створення об'єкта
