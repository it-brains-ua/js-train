...
printIndexes([1, 2, 3, 4, 5]); // Виведе 0, 1, 2, 3, 4
...
function modifyArray(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    // Перетворюємо елемент в рядок та виводимо на консоль
...
// За допомогою циклу for-in переберіть масив, перетворіть кожен елемент в рядок за допомогою методу toString(). Результат виведіть на консоль.
function printStrings(array) {
  // Перебираємо масив за допомогою циклу for-in
  for (let index in array) {
    // Перетворюємо поточний елемент в рядок та виводимо його на консоль
    console.log(array[index].toString());
  }
}

console.log("Завдання 7 ====================================");
printStrings([1, "two", 3, "four", 5]); // Виведе 1 two 3 four 5

// Завдання 8: Функція приймає масив рядків.
// За допомогою циклу for переберіть масив, зліпіть всі рядки в один,
// перетворивши кожен елемент в рядок за допомогою методу toString(). Результат виведіть на консоль.
function concatenateStrings(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    // Перетворюємо поточний елемент в рядок та додаємо його до результату
...
concatenateStrings([1, "two", 3, "four", 5]); // Виведе "1two3four5"
